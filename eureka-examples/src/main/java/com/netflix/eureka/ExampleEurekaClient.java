...
public class ExampleEurekaClient {
    ...
    public static void main(String[] args) {
        ...
        DefaultEurekaClientConfig defaultEurekaClientConfig=  new DefaultEurekaClientConfig("eureka.");
        EurekaClient client = initializeEurekaClient(applicationInfoManager, defaultEurekaClientConfig);
