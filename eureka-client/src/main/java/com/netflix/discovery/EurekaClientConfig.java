 ...
 * mechanisms
 *默认配置提供了所需的大部分信息
 * {@link DefaultEurekaClientConfig}。用户只需要提供eureka
 * 服务器服务的url。Eureka服务器服务url可以由2配置
 * 机制
 ...
 * <em>Eureka</em>.
 *一旦注册了客户机，用户就可以从其中查找信息
 * {@link EurekaClient}基于<em> virtual hostname 虚拟主机名</em>(也称为
 * 最常用的方法或通过其他方式获得
 * 与已注册的其他实例对话所需的信息
 * < em >Eureka< / em >。
 * <p>
...
public interface EurekaClientConfig {
     ...
     * 向 Eureka-Server 同步 应用信息 变化 初始化 延迟，单位：秒。
     */
